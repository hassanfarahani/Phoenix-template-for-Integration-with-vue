defmodule Widgets.Exercises do
  @moduledoc """
  ...
  def list_exercises do
    ...
    |> Enum.map(fn exercise ->
      %{exercise | properties_display: Jason.encode!(exercise.properties)}
    end)
  end
  ...
  def get_exercise!(id) do
    ...
    %Exercise{exercise | properties_display: Jason.encode!(exercise.properties, pretty: true)}
  end
